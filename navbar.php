    ...
    <div class="container-fluid iconDiv">
        ...
        <div class="d-flex gap-3">
            ...
            ?>
                ...
                ?>" alt="" class="img-fluid rounded-circle border border-primary" style="width:40px; height:40px; object-fit: cover;">
                    </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item my-auto">
                    <a class="nav-link" aria-current="page" href="./"><i class="fa-solid fa-house" style="font-size: 13px; vertical-align: baseline;"></i>
                        Home</a>
                </li>
                <li class="nav-item my-auto">
                    <a class="nav-link" href="./"><i class="fa-solid fa-book" style=" font-size: 13px; vertical-align: baseline;"></i>
                        About</a>
                </li>
                <li class="nav-item my-auto">
                ...
                <li class="nav-item my-auto">
                    <a class="nav-link" href="./"><i class="fa-solid fa-comment" style=" font-size: 13px; vertical-align: baseline;"></i>
                        Contact</a>
                </li>
            ...
            <form class="d-flex" role="search">
                <div class="input-group flex-nowrap">
                    <input type="text" class="form-control" id="search" placeholder="Search" aria-label="Search" aria-describedby="addon-wrapping">
                    <label class="input-group-text searchBox" id="addon-wrapping" for="search"><i class="fa-solid fa-magnifying-glass"></i></label>
                </div>
            </form>
        </div>
    </div>
